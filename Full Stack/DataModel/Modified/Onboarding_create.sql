...
-- Last modification date: 2019-12-28 06:30:48.19
...
CREATE TABLE PersonalInfo (
    ...
    State1 nvarchar(max)  NOT NULL,
    Country1 nvarchar(max)  NOT NULL,
    Address2 nvarchar(max)  NOT NULL,
    City2 nvarchar(max)  NOT NULL,
    State2 nvarchar(max)  NOT NULL,
    Country2 nvarchar(max)  NOT NULL,
