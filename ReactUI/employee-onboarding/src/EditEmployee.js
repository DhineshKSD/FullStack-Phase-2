...
class Edit extends React.Component {  
  ...
  componentDidMount() {  
      axios.get('http://localhost:52564/Api/Employee/EmployeedetailById?id='+this.props.match.params.id)  
          .then(response => {  
              this.setState({   
  ...
  onSubmit(e) {  
    ...
    axios.post('http://localhost:52564/Api/Employee/AddotrUpdateEmployee/', obj)  
